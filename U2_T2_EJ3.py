...
x_vals = np.linspace(0, 2, 100) # intervalo más adecuado para este problema 
y_vals = g(x_vals)
...
f_vals = np.exp(x_vals) - 4*x_vals 
plt.plot(x_vals, f_vals, color="green", label=r"$f(x) = e^x - 4x$")
